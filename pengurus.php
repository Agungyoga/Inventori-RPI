...
<html>
<head>
<title>Fortune Estates a Mobile App Flat Bootstrap Responsive Website Template | Agents :: W3layouts</title> 
		...
		<div class="content-wrap">
			...
			<div class="content">
				...
				<div class="w3agile agents"> 
					<h3 class="w3ls-title">Our Agents</h3> 
					<div class="w3agent-grid"> 
						...
						<div class="w3agent-text"> 
							...
							<p><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Broome St, Canada, NY 02, USA</p>
						</div>
					</div>
					<div class="w3agent-grid"> 
						<div class="stack twisted">	
						...
						<div class="w3agent-text"> 
							<h4>Michael amet</h4>
							<p><i class="glyphicon glyphicon-earphone"></i> (234)444 22233</p>
							<p><i class="glyphicon glyphicon-phone"></i> (2222)111 23456</p> 
							<p><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com"> mail@example.com</a></p>
							<p><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Lorem St, Canada, NY 02, USA</p>
						</div>
					</div>
					<div class="w3agent-grid"> 
						<div class="stack twisted">	
